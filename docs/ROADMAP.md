...
- complete player-side pickup/damage semantics, ground-obstacle rollback/render/terrain mutation beyond the recovered Rect store, and the special `0x17E70` destruction path;
...
- finish player inventory/life mutation, ground-obstacle tick rollback plus renderer/terrain mutation beyond the recovered Rect store, the special `0x17E70` destruction branch, and remaining destruction entry-site orchestration;
